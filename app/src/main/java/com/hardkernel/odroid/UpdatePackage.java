...
class UpdatePackage {
    ...
    private static final String BRANCH = "s805_5.1.1_master";

    public static final long PACKAGE_MAXSIZE = 400 * 1024 * 1024;   /* 400MB */

    public final static String OFFICAL_SERVER_URL =
        "http://dn.odroid.com/S805/Android/ODROID-C/";
    public final static String MIRROR_SERVER_URL =
        "http://www.odroid.in/mirror/dn.odroid.com/S805/Android/ODROID-C/";
